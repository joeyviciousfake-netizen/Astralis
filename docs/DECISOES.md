...
- D16 2026-09-23: Ferramentas oficiais de dev: Godot MCP asset 5470 (Benjiarml, MIT, Python 3.11-3.14) para operar o editor via IA + GUT asset 1709 (bitwes, MIT) para testes. Instalação só quando começar pasta astralis/. | motivo: escolha do usuário, alinhado aos docs 03/10/11 | impacto: runtime usa MCP, qa usa GUT; Python 3.14 local já atende
