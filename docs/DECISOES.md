...
- D29 2026-09-24: Studio abre SEMPRE vazio (toda abertura zera o projeto; sessão anterior vai p/ backup invisível); conteúdo só via Importar; jogo lê via --project (+ --setup por cima). | motivo: usuário manda abrir vazio toda vez | impacto: runtime --project; editor preparar_boot; examples/ segue p/ testes
