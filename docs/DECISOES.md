...
- D29 2026-09-25: Studio abre SEMPRE vazio (toda abertura APAGA tudo do projeto e recria o esqueleto vazio; SEM backup, sem sessao_*, nada guardado); conteúdo só via Importar; jogo lê via --project (+ --setup por cima). | motivo: ordem literal do usuário | impacto: runtime --project; editor preparar_boot; examples/ segue p/ testes
- D29 2026-09-25: Studio abre SEMPRE vazio (toda abertura APAGA tudo do projeto e recria o esqueleto vazio; SEM backup, sem sessao_*, nada guardado)
